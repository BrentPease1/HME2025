...
-   Same researcher has studied this species in other remnant patches
    ...
    -   Therefore, prior to collecting new data, we can use this information to think about the expected distribution of tree diameter of mean diameter (e.g., between 43 - 63cm (mean + 1.96\*sd))
    -   This is "prior knowledge"!
    -   how could we formulate this into a **prior distribution**?

## The Model of the Mean

-   Unlike the frog example in which we explicitly assigned a value to the prior (e.g., 0.5), here we will have prior **distributions**
...
What if I asked you to use a model to estimate the mean and the standard
...
MCMCplots Results [here](files_for_slides/tree_model01.html)
...
MCMCplots Results [here](files_for_slides/tree_model02.html)
...
MCMCplots Results [here](files_for_slides/tree_model03.html)
...
MCMCplots Results [here](files_for_slides/tree_model04.html)
...
knitr::include_graphics(here::here('Modules/02_Intro_Bayes/files_for_slides/falcon.jpg'))
```
...
```{r scipt, echo = F}
# knitr::purl(input = here::here('Modules/02_Intro_Bayes/04_Eucalypt_trees.Rmd'),
#             output = here::here('Modules/02_Intro_Bayes/04_Eucalypt_trees.R'))
```
