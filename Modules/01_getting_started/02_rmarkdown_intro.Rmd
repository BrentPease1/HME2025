...
1)  **Your adviser doesn't use it** - Try sending a `.Rmd` file to your adviser to get feedback. I'll wait... Like it or not, most folks still use word processors, so if you adopt R Markdown you will still have to create and edit Word documents for some collaborators who are stuck in their ways. That is okay, though - knowing several tools can be helpful when working with a range of folks across disciplines.
...
There many possible options for the header (see [here](https://posit.co/wp-content/uploads/2022/10/rmarkdown-1.pdf) for additional examples). We'll learn more about some of these options later in the semester.
...
RStudio's [R Markdown](https://rmarkdown.rstudio.com/) tutorial

Tom Edward's [R Markdown](http://learnr.usu.edu/r_markdown/1_1_markdown.php) tutorial

Coding Club's [Getting Started with R Markdown](https://ourcodingclub.github.io/tutorials/rmarkdown/)
